...
const addRowAddress = (indirizzo) => { // console.log(indirizzo);
    ...
    newBtnView.classList.add('btn', 'btn-view', 'btn-primary', 'btn-bd', 'btn-bxsh');
    newBtnView.innerHTML = 'Mostra';
    box.appendChild(newBtnView);

    // crea Buttone Modifica
    const newBtnEdit = document.createElement('BUTTON');
    newBtnEdit.classList.add('btn', 'btn-edit', 'btn-warning', 'btn-bd', 'btn-bxsh');
    newBtnEdit.innerHTML = 'Modifica';
    box.appendChild(newBtnEdit);

    // crea Buttone Cancella
    const newBtnDelete = document.createElement('BUTTON');
    newBtnDelete.classList.add('btn', 'btn-delete', 'btn-danger', 'btn-bd', 'btn-bxsh');
    newBtnDelete.innerHTML = 'Cancella';
