...
const addRowSql = () => {
    ...
    const obj = { action: 'add', principale: principale, clienteId: clienteId, indirizzo: indirizzo, via: via, civico: civico, cap: cap, comune: comune, provincia: provincia, nazione: nazione };
...
const deleteRowSql = (button) => {
    ...
    const obj = { action: 'delete', idAddress: idAddress };
    const str = JSON.stringify(obj);
