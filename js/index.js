...
document.querySelector('#select-clienti').addEventListener('change', (event) => {
    ...
    if (optionValue === '0') {
        ...
        // document.querySelector('.btn-edit-cliente').disabled = true;
        // document.querySelector('.btn-save-cliente').disabled = true;
        // document.querySelector('.btn-del-cliente').disabled = true;
    ...
    // document.querySelector('.btn-edit-cliente').removeAttribute('disabled');
    // document.querySelector('.btn-save-cliente').disabled = true;
    // document.querySelector('.btn-del-cliente').disabled = true;
    ...
    const url = 'query-on-user-action';
