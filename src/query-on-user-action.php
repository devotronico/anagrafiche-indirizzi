...
$str = '{"status": "error", "file": "' . $file . '", "section": "'.$query.'", "filter": "'.$id.'",'; // DEBUG

if (file_exists('conn.php')) { require_once 'conn.php'; } else { die('{"status": "error", "error": "php", "file": "' . $file . '", "line": "'.__LINE__.'", "mess": "file conn.php non trovato"}'); }
// $query = 'clienti'; $id = 1; // DEBUG
switch ($query) {
    case 'clienti':
